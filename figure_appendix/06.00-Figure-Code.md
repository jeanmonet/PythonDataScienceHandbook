...
fig.savefig('fig/02.05-broadcasting.png')
```
...
fig.savefig('fig/03.08-split-apply-combine.png')
```
...
fig.savefig('fig/05.01-classification-1.png')
```
...
fig.savefig('fig/05.01-classification-2.png')
```
...
fig.savefig('fig/05.01-classification-3.png')
```
...
fig.savefig('fig/05.01-regression-1.png')
```
...
fig.savefig('fig/05.01-regression-2.png')
```
...
fig.savefig('fig/05.01-regression-3.png')
```
...
fig.savefig('fig/05.01-regression-4.png')
```
...
fig.savefig('fig/05.01-clustering-1.png')
```
...
fig.savefig('fig/05.01-clustering-2.png')
```
...
fig.savefig('fig/05.01-dimesionality-1.png')
```
...
fig.savefig('fig/05.01-dimesionality-2.png')
```
...
fig.savefig('fig/05.02-samples-features.png')
```
...
fig.savefig('fig/05.03-2-fold-CV.png')
```
...
fig.savefig('fig/05.03-5-fold-CV.png')
```
...
fig.savefig('fig/05.03-bias-variance.png')
```
...
fig.savefig('fig/05.03-bias-variance-2.png')
```
...
fig.savefig('fig/05.03-validation-curve.png')
```
...
fig.savefig('fig/05.03-learning-curve.png')
```
...
fig.savefig('fig/05.05-gaussian-NB.png')
```
...
fig.savefig('fig/05.06-gaussian-basis.png')
```
...
fig.savefig('fig/05.08-decision-tree.png')
```
...
fig.savefig('fig/05.08-decision-tree-levels.png')
```
...
fig.savefig('fig/05.08-decision-tree-overfitting.png')
```
...
fig.savefig('fig/05.09-PCA-rotation.png')
```
...
fig.savefig('fig/05.09-digits-pixel-components.png')
```
...
fig.savefig('fig/05.09-digits-pca-components.png')
```
...
fig.savefig('fig/05.10-LLE-vs-MDS.png')
```
...
fig.savefig('fig/05.11-expectation-maximization.png')
```
...
fig.savefig('fig/05.12-covariance-type.png')
```
