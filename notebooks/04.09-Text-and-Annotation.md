...
<!--NAVIGATION-->
< [Multiple Subplots](04.08-Multiple-Subplots.md) | [Contents](Index.md) | [Customizing Ticks](04.10-Customizing-Ticks.md) >

<a href="https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/04.09-Text-and-Annotation.md"><img align="left" src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" title="Open and Execute in Google Colaboratory"></a>
...
Let's return to some data we worked with earler, in ["Example: Birthrate Data"](03.09-Pivot-Tables.md#Example:-Birthrate-Data), where we generated a plot of average births over the course of the calendar year; as already mentioned, that this data can be downloaded at https://raw.githubusercontent.com/jakevdp/data-CDCbirths/master/births.csv.
