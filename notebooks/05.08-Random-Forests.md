...
<!--NAVIGATION-->
< [In-Depth: Support Vector Machines](05.07-Support-Vector-Machines.md) | [Contents](Index.md) | [In Depth: Principal Component Analysis](05.09-Principal-Component-Analysis.md) >

<a href="https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/05.08-Random-Forests.md"><img align="left" src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" title="Open and Execute in Google Colaboratory"></a>
...
Previously we have looked in depth at a simple generative classifier (naive Bayes; see [In Depth: Naive Bayes Classification](05.05-Naive-Bayes.md)) and a powerful discriminative classifier (support vector machines; see [In-Depth: Support Vector Machines](05.07-Support-Vector-Machines.md)).
...
[figure source in Appendix](06.00-Figure-Code.md#Decision-Tree-Example)
...
[figure source in Appendix](06.00-Figure-Code.md#Decision-Tree-Levels)
...
If you're running this notebook live, you can use the helpers script included in [The Online Appendix](06.00-Figure-Code.md#Helper-Code) to bring up an interactive visualization of the decision tree building process:
...
[figure source in Appendix](06.00-Figure-Code.md#Decision-Tree-Overfitting)
...
Earlier we took a quick look at the hand-written digits data (see [Introducing Scikit-Learn](05.02-Introducing-Scikit-Learn.md)).
