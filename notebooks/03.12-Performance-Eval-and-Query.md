...
<!--NAVIGATION-->
< [Working with Time Series](03.11-Working-with-Time-Series.md) | [Contents](Index.md) | [Further Resources](03.13-Further-Resources.md) >

<a href="https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/03.12-Performance-Eval-and-Query.md"><img align="left" src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" title="Open and Execute in Google Colaboratory"></a>
...
As discussed in [Computation on NumPy Arrays: Universal Functions](02.03-Computation-on-arrays-ufuncs.md), this is much faster than doing the addition via a Python loop or comprehension:
