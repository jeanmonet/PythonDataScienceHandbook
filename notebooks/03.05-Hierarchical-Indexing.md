...
<!-- #region {"deletable": true, "editable": true} -->
<!--NAVIGATION-->
< [Handling Missing Data](03.04-Missing-Values.md) | [Contents](Index.md) | [Combining Datasets: Concat and Append](03.06-Concat-And-Append.md) >

<a href="https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/03.05-Hierarchical-Indexing.md"><img align="left" src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" title="Open and Execute in Google Colaboratory"></a>
...
<!-- #region {"deletable": true, "editable": true} -->
In addition, all the ufuncs and other functionality discussed in [Operating on Data in Pandas](03.03-Operations-in-Pandas.md) work with hierarchical indices as well.
...
<!-- #region {"deletable": true, "editable": true} -->
Other types of indexing and selection (discussed in [Data Indexing and Selection](03.02-Data-Indexing-and-Selection.md)) work as well; for example, selection based on Boolean masks:
<!-- #endregion -->
...
<!-- #region {"deletable": true, "editable": true} -->
Also, as with the single-index case, we can use the ``loc``, ``iloc``, and ``ix`` indexers introduced in [Data Indexing and Selection](03.02-Data-Indexing-and-Selection.md). For example:
<!-- #endregion -->
...
This syntax is actually a short cut to the ``GroupBy`` functionality, which we will discuss in [Aggregation and Grouping](03.08-Aggregation-and-Grouping.md).
...
In particular, the ``ix``, ``loc``, and ``iloc`` indexers discussed in [Data Indexing and Selection](03.02-Data-Indexing-and-Selection.md) extend readily to these higher-dimensional structures.
...
If you'd like to read more about the ``Panel`` and ``Panel4D`` structures, see the references listed in [Further Resources](03.13-Further-Resources.md).
<!-- #endregion -->
