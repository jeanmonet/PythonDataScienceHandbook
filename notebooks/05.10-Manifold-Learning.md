...
<!--NAVIGATION-->
< [In Depth: Principal Component Analysis](05.09-Principal-Component-Analysis.md) | [Contents](Index.md) | [In Depth: k-Means Clustering](05.11-K-Means.md) >

<a href="https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/05.10-Manifold-Learning.md"><img align="left" src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" title="Open and Execute in Google Colaboratory"></a>
...
[figure source in Appendix](06.00-Figure-Code.md#LLE-vs-MDS-Linkages)
...
We will use the Labeled Faces in the Wild dataset, which we previously saw in [In-Depth: Support Vector Machines](05.07-Support-Vector-Machines.md) and [In Depth: Principal Component Analysis](05.09-Principal-Component-Analysis.md).
...
We could then go on to classify this data (perhaps using manifold features as inputs to the classification algorithm) as we did in [In-Depth: Support Vector Machines](05.07-Support-Vector-Machines.md).
...
This data is similar to the digits we saw in [In-Depth: Decision Trees and Random Forests](05.08-Random-Forests.md), but with many more pixels per image.
