...
<!-- #region {"deletable": true, "editable": true} -->
<!--NAVIGATION-->
< [Further Machine Learning Resources](05.15-Learning-More.md) | [Contents](Index.md) |

<a href="https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/06.00-Figure-Code.md"><img align="left" src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" title="Open and Execute in Google Colaboratory"></a>
...
[Figure Context](02.05-Computation-on-arrays-broadcasting.md#Introducing-Broadcasting)
<!-- #endregion -->
...
[Figure context](05.01-What-Is-Machine-Learning.md#Classification:-Predicting-Discrete-Labels)
...
[Figure Context](05.01-What-Is-Machine-Learning.md#Regression:-Predicting-Continuous-Labels)
...
[Figure context](05.01-What-Is-Machine-Learning.md#Dimensionality-Reduction:-Inferring-Structure-of-Unlabeled-Data)
...
[Figure Context](05.05-Naive-Bayes.md#Gaussian-Naive-Bayes)
<!-- #endregion -->
...
[Figure Context](05.06-Linear-Regression.md#Gaussian-Basis-Functions)
<!-- #endregion -->
...
The following will create a module ``helpers_05_08.py`` which contains some tools used in [In-Depth: Decision Trees and Random Forests](05.08-Random-Forests.md).
<!-- #endregion -->
...
[Figure Context](05.11-K-Means.md#K-Means-Algorithm:-Expectation-Maximization)
...
[Figure Context](http://localhost:8888/notebooks/05.12-Gaussian-Mixtures.md#Choosing-the-Covariance-Type)
<!-- #endregion -->
