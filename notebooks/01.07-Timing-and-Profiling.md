...
<!--NAVIGATION-->
< [Errors and Debugging](01.06-Errors-and-Debugging.md) | [Contents](Index.md) | [More IPython Resources](01.08-More-IPython-Resources.md) >

<a href="https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/01.07-Timing-and-Profiling.md"><img align="left" src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" title="Open and Execute in Google Colaboratory"></a>
...
We saw the ``%timeit`` line-magic and ``%%timeit`` cell-magic in the introduction to magic functions in [IPython Magic Commands](01.03-Magic-Commands.md); it can be used to time the repeated execution of snippets of code:
