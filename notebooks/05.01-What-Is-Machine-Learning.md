...
<!-- #region {"deletable": true, "editable": true} -->
<!--NAVIGATION-->
< [Machine Learning](05.00-Machine-Learning.md) | [Contents](Index.md) | [Introducing Scikit-Learn](05.02-Introducing-Scikit-Learn.md) >

<a href="https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/05.01-What-Is-Machine-Learning.md"><img align="left" src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" title="Open and Execute in Google Colaboratory"></a>
...
For a preview of these more technical aspects, you can find the Python source that generates the following figures in the [Appendix: Figure Code](06.00-Figure-Code.md).
...
[figure source in Appendix](06.00-Figure-Code.md#Classification-Example-Figure-1)
<!-- #endregion -->
...
[figure source in Appendix](06.00-Figure-Code.md#Classification-Example-Figure-2)
<!-- #endregion -->
...
[figure source in Appendix](06.00-Figure-Code.md#Classification-Example-Figure-3)
<!-- #endregion -->
...
We will see an example of such text-based classification in [In Depth: Naive Bayes Classification](05.05-Naive-Bayes.md).

Some important classification algorithms that we will discuss in more detail are Gaussian naive Bayes (see [In Depth: Naive Bayes Classification](05.05-Naive-Bayes.md)), support vector machines (see [In-Depth: Support Vector Machines](05.07-Support-Vector-Machines.md)), and random forest classification (see [In-Depth: Decision Trees and Random Forests](05.08-Random-Forests.md)).
<!-- #endregion -->
...
[figure source in Appendix](06.00-Figure-Code.md#Regression-Example-Figure-1)
<!-- #endregion -->
...
[figure source in Appendix](06.00-Figure-Code.md#Regression-Example-Figure-2)
<!-- #endregion -->
...
[figure source in Appendix](06.00-Figure-Code.md#Regression-Example-Figure-3)
<!-- #endregion -->
...
[figure source in Appendix](06.00-Figure-Code.md#Regression-Example-Figure-4)
<!-- #endregion -->
...
Some important regression algorithms that we will discuss are linear regression (see [In Depth: Linear Regression](05.06-Linear-Regression.md)), support vector machines (see [In-Depth: Support Vector Machines](05.07-Support-Vector-Machines.md)), and random forest regression (see [In-Depth: Decision Trees and Random Forests](05.08-Random-Forests.md)).
<!-- #endregion -->
...
[figure source in Appendix](06.00-Figure-Code.md#Clustering-Example-Figure-2)
<!-- #endregion -->
...
Using the very fast and intuitive *k*-means algorithm (see [In Depth: K-Means Clustering](05.11-K-Means.md)), we find the clusters shown in the following figure:
<!-- #endregion -->
...
We will discuss the *k*-means algorithm in more depth in [In Depth: K-Means Clustering](05.11-K-Means.md).
Other important clustering algorithms include Gaussian mixture models (See [In Depth: Gaussian Mixture Models](05.12-Gaussian-Mixtures.md)) and spectral clustering (See [Scikit-Learn's clustering documentation](http://scikit-learn.org/stable/modules/clustering.html)).
<!-- #endregion -->
...
Different dimensionality reduction routines measure these relevant qualities in different ways, as we will see in [In-Depth: Manifold Learning](05.10-Manifold-Learning.md).
...
[figure source in Appendix](06.00-Figure-Code.md#Dimensionality-Reduction-Example-Figure-1)
<!-- #endregion -->
...
[figure source in Appendix](06.00-Figure-Code.md#Dimensionality-Reduction-Example-Figure-2)
<!-- #endregion -->
...
Some important dimensionality reduction algorithms that we will discuss are principal component analysis (see [In Depth: Principal Component Analysis](05.09-Principal-Component-Analysis.md)) and various manifold learning algorithms, including Isomap and locally linear embedding (See [In-Depth: Manifold Learning](05.10-Manifold-Learning.md)).
<!-- #endregion -->
...
All of the figures in the preceding discussion are generated based on actual machine learning computations; the code behind them can be found in [Appendix: Figure Code](06.00-Figure-Code.md).
<!-- #endregion -->
