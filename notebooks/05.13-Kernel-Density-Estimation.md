...
<!-- #region {"deletable": true, "editable": true} -->
<!--NAVIGATION-->
< [In Depth: Gaussian Mixture Models](05.12-Gaussian-Mixtures.md) | [Contents](Index.md) | [Application: A Face Detection Pipeline](05.14-Image-Features.md) >

<a href="https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/05.13-Kernel-Density-Estimation.md"><img align="left" src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" title="Open and Execute in Google Colaboratory"></a>
...
For example, in the Seaborn visualization library (see [Visualization With Seaborn](04.14-Visualization-With-Seaborn.md)), KDE is built in and automatically used to help visualize points in one and two dimensions.
...
<!-- #region {"deletable": true, "editable": true} -->
With this data loaded, we can use the Basemap toolkit (mentioned previously in [Geographic Data with Basemap](04.13-Geographic-Data-With-Basemap.md)) to plot the observed locations of these two species on the map of South America.
<!-- #endregion -->
...
In [In Depth: Naive Bayes Classification](05.05-Naive-Bayes.md), we took a look at naive Bayesian classification, in which we created a simple generative model for each class, and used these models to build a fast classifier.
...
We also provide a doc string, which will be captured by IPython's help functionality (see [Help and Documentation in IPython](01.01-Help-And-Documentation.md)).
<!-- #endregion -->
...
Here we will load the digits, and compute the cross-validation score for a range of candidate bandwidths using the ``GridSearchCV`` meta-estimator (refer back to [Hyperparameters and Model Validation](05.03-Hyperparameters-and-Model-Validation.md)):
<!-- #endregion -->
